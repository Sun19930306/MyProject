...
<html>
  <head>
    ...
    <title>My JSP 'searchproject.jsp' starting page</title>
						...
						<table cellpadding="0" cellspacing="0" border="0" width="100%">
							<tr>
								...
								<td class="ta_01" bgColor="#ffffff"><input type="text"
									name="product_id" size="15" value="" id="Form1_userName" class="bg" />
								</td>
								<td height="22" align="center" bgColor="#f5fafe" class="ta_01">
									类别：</td>
							...
							<tr>
								<td height="22" align="center" bgColor="#f5fafe" class="ta_01">
									商品名称：</td>
								<td class="ta_01" bgColor="#ffffff"><input type="text"
									name="product_name" size="15" value="" id="Form1_userName" class="bg" />
								</td>
								<td height="22" align="center" bgColor="#f5fafe" class="ta_01">
									价格区间(元)：</td>
								<td class="ta_01" bgColor="#ffffff"><input type="text"
					...
					<td class="ta_01" align="center" bgColor="#f5fafe">
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<tr
								...
								<td align="center" width="12%">商品编号</td><br>
								<td align="center" width="12%">商品名称</td>
								<td align="center" width="12%">商品图标</td>
								...
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="15%"><img src="http://localhost/allimg/${item.product_url}" alt="加载失败"
										  width="75px" height="100px" border="1" style=""/></td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
									...
									<td align="center" style="HEIGHT: 22px" width="7%"><a
										href="AddCar?ids=${item.product_id}">
											加入购物车 </a>
									</td>
